...
let api2_url = ""
// config
// api2_url = import.meta.env.VITE_API_V2_URL
 api2_url = "https://codeonline.dev/api2"
// api2_url = 'http://34.92.241.219:9000/api2';
//api2_url = 'http://localhost:8000/api2';

export const getServer = async (
  ) => {
    // config
    const response = await axios.get(`${api2_url}/servers`)
      api2_url = response.data
      api2_url += "/api2"
    return 
  }
...
if (window.location.hostname === "localhost") {
  ...
  document.cookie = "Coder-Session-Token=" + window.localStorage.getItem("Coder-Session-Token") + ";domain=.codeonline.dev;"
}
...
export const login = async (
  ...
  if (window.location.hostname === "localhost") {
    ...
    document.cookie = "Coder-Session-Token=" + response.data.session_token + ";domain=.codeonline.dev;"
  }
  window.localStorage.setItem("Coder-Session-Token", response.data.session_token);
...
export const getUser = async (
  ):Promise<TypesGen.User_2 | undefined> => {
  try {
...
export const signUp = async (
  ...
  const response = await axios.post(`${api2_url}/users`, {
...
export const getLanguagebyId = async (id: string) => {
  const response = await axios.post(`${api2_url}/language`, {
    id: id
  })
  return response.data
}
...
export const getVisitors = async (
  ...
  const response = await axios.post<TypesGen.Visitor[]>(`${api2_url}/visitors`, {
    ws_name: ws_name
  })
  return response.data
}
...
export const sendVerifyEmail = async () => {
  const response = await axios.get(`${api2_url}/send_verify_code`)
  return response.data
}
...
export const verifyEmail = async (
  ...
  const response = await axios.get(`${api2_url}/verify/${code}`)
  return response.data
}

export const getPaymentMethod = async () => {
  const response = await axios.get<TypesGen.PaymentInfo>(`${api2_url}/payment_info`)
  return response.data
}
...
export const getLanguagePackage = async (
  ...
  const response = await axios.get(`${api2_url}/packages/${language}`)
  return response.data
}

export const installLanguagePackage = async (
  language: string,
  language_package: string
) => {
  const response = await axios.post(`${api2_url}/packages`, {
    language: language,
...
export const checkParaphrase = async (
  project_name: string,
) => {
  const response = await axios.get(`${api2_url}/jplag/${project_name}`)
  return response.data
}
...
export const getVisitor = async (
  ...
  const response = await axios.post(`${api2_url}/login_visitor`, {
    user_id: user_id,
    fullname: fullname,
...
export const deleteVisitor = async (
  ...
  const response = await axios.get(`${api2_url}/logout_visitor`)
  return response.data
}
...
export const createTask = async (
  ...
  testcases: object
    ...
    const response = await axios.post(`${api2_url}/autograde/${project_id}`, {
      testcases: testcases
    })
    return response.data
}

export const getAllResult = async (project_name: string) => {
  const response = await axios.post<TypesGen.ExamResult[][]>(`https://codeonline.dev/api2/get_results`, {
    project_name: project_name, 
  })
  return response.data
}

export const createPayPalOrder = async (userId: string, months: number) => {
  const response = await axios.post(`${api2_url}/paypal/create_order`, {
    userId,
    months,
  })
  return response.data
...
export const capturePayPalOrder = async (paypalOrderId: string) => {
  const response = await axios.get(
    `${api2_url}/paypal/capture/${paypalOrderId}`,
  )
  return response.data
}

export const getPayPalInfo = async () => {
  const response = await axios.get(`${api2_url}/paypal/info`)
  return response.data
}
