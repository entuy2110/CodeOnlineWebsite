...
import PricePage from "pages/UserSettingsPage/PricePage/PricePage"
import { InstallPage } from "pages/InstallPage/InstallPage"
import { TaskPage } from "pages/TaskPgae/TaskPage"
        ...
        <Routes>
          ...
          <Route element={<RequireAuth />}>
            <Route element={<DashboardLayout />}>
              ...
              <Route path="install/:language" element={<InstallPage />} />
              <Route path="exam_result/:project_name" element={<ExamResultPage />} />
              ...
              <Route path="/@:username">
                <Route path=":project">
                  ...
                  {/* <Route path="task/:sub_project" element={<TaskPage />} /> */}
                  <Route path="edit/:project_name" element={<EditTaskPage />} />
